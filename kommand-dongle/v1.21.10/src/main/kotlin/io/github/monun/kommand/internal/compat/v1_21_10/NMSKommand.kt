...
import io.github.monun.kommand.internal.compat.v1_21_10.NMSKommandContext.Companion.wrapContext
import io.github.monun.kommand.internal.compat.v1_21_10.NMSKommandSource.Companion.wrapSource
...
class NMSKommand : AbstractKommand() {
    ...
    override fun register(dispatcher: KommandDispatcherImpl, aliases: List<String>) {
        ...
        commandMap.register(
            root.fallbackPrefix,
            VanillaCommandWrapper(node).apply {
